...
def get_quote_by_id_query(id):
    select_by_id = "SELECT * FROM quotes WHERE id={}".format(id)
    return select_by_id
...
def create_quote():
    data = request.json
    db_query_exec(add_new_quote_query(author=data.get("author"), text=data.get("text")))
    print("data = ", data)
    return data, 201
